    ...
    public partial class CreateIdentitySchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VagaTecs", x => new { x.Vaga_Id, x.Tecnologia_Id });
                    table.ForeignKey(
                        name: "FK_VagaTecs_Tecnologias_Tecnologia_Id",
                        column: x => x.Tecnologia_Id,
                        principalTable: "Tecnologias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VagaTecs_Vagas_Vaga_Id",
                        column: x => x.Vaga_Id,
                        principalTable: "Vagas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuncTecs", x => new { x.Funcionario_Id, x.Tecnologia_Id });
                    table.ForeignKey(
                        name: "FK_FuncTecs_Funcionarios_Funcionario_Id",
                        column: x => x.Funcionario_Id,
                        principalTable: "Funcionarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FuncTecs_Tecnologias_Tecnologia_Id",
                        column: x => x.Tecnologia_Id,
                        principalTable: "Tecnologias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuncTecs_Tecnologia_Id",
                table: "FuncTecs",
                column: "Tecnologia_Id");

            migrationBuilder.CreateIndex(
                name: "IX_VagaTecs_Tecnologia_Id",
                table: "VagaTecs",
                column: "Tecnologia_Id");
        }
